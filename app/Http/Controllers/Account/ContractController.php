...
class ContractController extends Controller {
	...
	public function getPageOne(Contract $contract, $id = null) {
		...
		//$sourcesNumber = ($contract->source_id) ? $contract->source_id : '';
		return view('account.contract.page-one', compact('contract', 'branches', 'contractNumber','sources'));
	...
	public function postPageOne(Request $request) {
		...
		$postal_code = $request->postal_code1 . $request->postal_code2 . $request->postal_code3 . $request->postal_code4 . $request->postal_code5;
		$kodepos = KodePos::where('kodepos', $postal_code)->first();// ? 'X' : '' ;
		if(isset($kodepos->kodepos)){
			$request->postal_codes = $postal_code;
		}else{
		...
		$model->postal_code = $postal_code;//$request->postal_code1 . $request->postal_code2 . $request->postal_code3 . $request->postal_code4 . $request->postal_code5;
	...
	public function postPageTwo(Request $request) {
		...
		if($model->payment_type == "Cash" || $request->payment_type == "COD" ){
	...
	public function getPageThree($id) {
		...
		return view('account.contract.page-three', compact('contract', 'products', 'children', 'productSeries'));
	}
